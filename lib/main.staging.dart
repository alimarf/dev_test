...
import 'package:dev_test_app/app/di.dart';
import 'package:dev_test_app/app/initializer.dart';
import 'package:dev_test_app/di.dart';
import 'package:dev_test_app/initilizer.dart';
...
Future<void> main() async {
  runZonedGuarded<Future<void>>(() async {
    ...
    await dotenv.load(fileName: "./environments/.env.staging");
