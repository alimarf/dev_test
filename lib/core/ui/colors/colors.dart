...
class AppColors {
  ...
  static MaterialColor primary = const MaterialColor(
    primaryValue,
    <int, Color>{
      100: Color(0xFF7A9B8A),
      200: Color(0xFF5A7A6A),
      300: Color(0xFF4A6A5A),
      400: Color(0xFF3A5A4A),
      500: Color(0xFF244B3A),
      600: Color(0xFF1F3F30),
      700: Color(0xFF1A3326),
      800: Color(0xFF15271C),
      900: Color(0xFF101B12),
    },
  );
  static const int primaryValue = 0xFF244B3A;
  static const Color buttonColor = Color(0xFF41745E);
  static const Color circleIconbuttonColor = Color(0xFFF4F4F4);
  static const Color primaryDark = Color(0xFF112F22);
  static const Color primaryLight = Color(0xFF7A9B8A);
  static const Color selectedColor = Color(0xFF244B3A);
  static const Color unselectedColor = Color(0xFFCBCBCB);
  static const Color serviceSectionColor = Color(0xFFF4F4F4);
  ...
  static const textTitleColor = Color(0xFF264F3D);
  static const textLinkColor = Color(0xFF46A0BF);
  static const textPriceColor = Color(0xFF00894D);
  static const textSubTitleColor = Color(0xFF707070);
